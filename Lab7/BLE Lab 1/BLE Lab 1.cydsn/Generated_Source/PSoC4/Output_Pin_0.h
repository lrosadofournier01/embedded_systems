...
#define Output_Pin_0_DM_ALG_HIZ         (0x00u)
#define Output_Pin_0_DM_DIG_HIZ         (0x01u)
#define Output_Pin_0_DM_RES_UP          (0x02u)
#define Output_Pin_0_DM_RES_DWN         (0x03u)
#define Output_Pin_0_DM_OD_LO           (0x04u)
#define Output_Pin_0_DM_OD_HI           (0x05u)
#define Output_Pin_0_DM_STRONG          (0x06u)
#define Output_Pin_0_DM_RES_UPDWN       (0x07u)
...
#if defined(Output_Pin_0__INTSTAT)  /* Interrupt Registers */

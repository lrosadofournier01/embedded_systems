...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Input_Pin_1_PC =   (Input_Pin_1_PC & \
                                (uint32)(~(uint32)(Input_Pin_1_DRIVE_MODE_IND_MASK << (Input_Pin_1_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Input_Pin_1_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  Input_Pin_1_DM_STRONG     Strong Drive 
*  Input_Pin_1_DM_OD_HI      Open Drain, Drives High 
*  Input_Pin_1_DM_OD_LO      Open Drain, Drives Low 
*  Input_Pin_1_DM_RES_UP     Resistive Pull Up 
*  Input_Pin_1_DM_RES_DWN    Resistive Pull Down 
*  Input_Pin_1_DM_RES_UPDWN  Resistive Pull Up/Down 
*  Input_Pin_1_DM_DIG_HIZ    High Impedance Digital 
*  Input_Pin_1_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(Input_Pin_1__0__SHIFT, mode);
}
...
*  
* Note:
*  Macro Input_Pin_1_ReadPS calls this function. 
*  
*******************************************************************************/
...
#if defined(Input_Pin_1_INTSTAT) 

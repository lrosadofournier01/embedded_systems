...
module ADC_SAR_SEQ_P4_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("4c69eb5c-05c3-4fbb-bc1a-a5b712b4ac1d/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module BLE_v3_66_1 (
	...
	cy_clock_v1_0
		#(.id("997e0b0c-60d9-4a38-8812-38f6282a2a37/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
    ...
    assign Net_1038 = 1'h0;

    OpAmp_P4_v1_20_2 Opamp (
        .Vminus(Net_1072),
        .Vout(Net_895),
        .Vplus(Net_1060));
